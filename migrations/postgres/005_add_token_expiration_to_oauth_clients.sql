-- Add token expiration fields to OAuth clients table
...
COMMENT ON COLUMN oauth_clients.access_token_expiration IS 'Access token lifetime in seconds (default: 86400 = 1 day)';
COMMENT ON COLUMN oauth_clients.refresh_token_expiration IS 'Refresh token lifetime in seconds (default: 1209600 = 14 days)';
