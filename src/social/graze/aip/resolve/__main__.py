...
async def realMain() -> None:
    ...
    parser.add_argument("--plc-hostname", default="plc.directory", help="The PLC hostname to use for resolving did-method-plc DIDs.")
    ...
    async with aiohttp.ClientSession() as session:
        for subject in subjects:
            try:
                resolved_handle = await resolve_subject(session, args.get("plc_hostname"), subject)
