    ...
    async fn store_client(&self, client: &OAuthClient) -> Result<()> {
        ...
        sqlx::query(
            ...
            INSERT INTO oauth_clients (
                ...
                require_redirect_exact, registration_access_token, jwks, application_type, software_id, software_version
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            "#,
        )
    ...
    async fn update_client(&self, client: &OAuthClient) -> Result<()> {
        ...
        let result = sqlx::query(
            ...
            UPDATE oauth_clients SET 
                ...
                refresh_token_expiration = ?, require_redirect_exact = ?, registration_access_token = ?, jwks = ?,
